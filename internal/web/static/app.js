...
(() => {
  ...
  var GROUP_LABELS = ["Claude + GPT", "Gemini Pro", "Gemini Flash", "Other"];
  ...
  function renderCopilotProviderSection(cp) {
    ...
    return '<div class="provider-section" data-provider="copilot"><div class="provider-header" data-toggle-provider="section-copilot"><div class="provider-header-left"><span class="provider-chevron" id="pchev-section-copilot">' + cpChevron + '</span><span class="provider-name">\u{1F419} GitHub Copilot</span><span class="provider-count">1 account</span></div></div><div class="provider-body' + cpCollapseClass + '" id="section-copilot"><div class="grid-header grid-copilot"><div>Account</div><div>Plan</div><div>Premium</div><div>Chat</div><div>Last Snap</div><div>Status</div></div><div class="account-card"><div class="account-row grid-copilot"><div class="account-info"><div class="account-email">' + esc(displayName) + "</div></div><div>" + (cp.plan ? '<span class="plan-badge">' + esc(cp.plan) + "</span>" : String.fromCharCode(8212)) + '</div><div class="quota-cell"><span class="quota-pct ' + premiumCls + '">' + premiumRem.toFixed(0) + '% left</span><div class="quota-minibar"><div class="quota-minibar-fill ' + premiumCls + '" style="width:' + premiumRem + '%"></div></div></div><div class="quota-cell"><span class="quota-pct ' + chatCls + '">' + chatRem.toFixed(0) + '% left</span><div class="quota-minibar"><div class="quota-minibar-fill ' + chatCls + '" style="width:' + chatRem + '%"></div></div></div><div class="snap-cell"><span class="snap-ago">' + capturedAgo + '</span></div><div class="status-cell"><span class="health-dot ' + dotCls + '">\u25CF ' + dotText + "</span></div></div></div></div></div>";
  }
